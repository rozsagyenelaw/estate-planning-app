...
console.log('Testing FIXED Single Living Trust Template\n');
...
try {
  ...
  // Regenerate the ZIP to apply changes
  ...
  fs.writeFileSync('/tmp/test_output_FIXED.docx', buf);

  console.log('\n✓ SUCCESS! No errors!');
  console.log('✓ Generated: /tmp/test_output_FIXED.docx');
