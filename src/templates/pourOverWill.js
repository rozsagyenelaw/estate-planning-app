...
<h1>Will of {{${prefix}_FULL_NAME}}</h1>
...
<h2>Article One</h2>
<h3 style="text-align: center;">Family Information</h3>

{{#IF_JOINT}}
<p>I am married to {{${prefix === 'CLIENT' ? 'SPOUSE' : 'CLIENT'}_FULL_NAME}}.  Any reference in this document to my {{${prefix}_SEX_REF === 'his' ? 'wife' : 'husband'}} is a reference to {{${prefix === 'CLIENT' ? 'SPOUSE' : 'CLIENT'}_FULL_NAME}}.</p>
{{/IF_JOINT}}

{{#IF_HAS_CHILDREN}}
<p>I have {{CHILDREN_COUNT}} {{CHILDREN_COUNT_WORD}}.  {{${prefix}_SEX_REF === 'his' ? 'Their' : 'Their'}} names are:</p>
{{#EACH_CHILDREN}}
<p class="indent-1">{{CHILD_FULL_NAME}}, born on {{CHILD_DOB_FORMATTED}}; </p>
{{/EACH_CHILDREN}}
<p>All references in my Will to my children are to these children.</p>
{{/IF_HAS_CHILDREN}}

<h2>Article Two</h2>
<h3 style="text-align: center;">Distribution of My Property</h3>
...
<h2>Article Three</h2>
<h3 style="text-align: center;">Designation and Succession of Fiduciaries</h3>

<div class="section">
<h3>Section 3.01      Personal Representative</h3>
{{#IF_JOINT}}
<p>I nominate {{${prefix === 'CLIENT' ? 'SPOUSE' : 'CLIENT'}_FULL_NAME}} as my Personal Representative.  If {{${prefix === 'CLIENT' ? 'SPOUSE' : 'CLIENT'}_FULL_NAME}} is unwilling or unable to act as my Personal Representative, I nominate {{POUROVER_SUCCESSOR_REP}} as my successor Personal Representative.</p>
{{/IF_JOINT}}
{{#IF_SINGLE}}
<p>I nominate {{POUROVER_SUCCESSOR_REP}} as my Personal Representative.</p>
{{/IF_SINGLE}}
</div>
...
<h2>Article Four</h2>
<h3 style="text-align: center;">Powers of Fiduciaries</h3>
...
<p class="indent-1">hold, retain, invest, reinvest, sell, and manage any real or personal property, including interests in any form of business entity including limited partnerships and limited liability companies, and life, health, and disability insurance policies, without diversification as to kind, amount, or risk of non-productivity and without limitation by statute or rule of law;</p>
<p class="indent-1">partition, sell, exchange, grant, convey, deliver, assign, transfer, lease, option, mortgage, pledge, abandon, borrow, loan, and contract;</p>
<p class="indent-1">distribute assets of my estate in cash or in kind, or partly in each, at fair market value on the distribution date, without requiring pro rata distribution of specific assets and without requiring pro rata allocation of the tax bases of those assets;</p>
<p class="indent-1">hold any interest in nominee form, continue businesses, carry out agreements, and deal with itself, other fiduciaries, and business organizations in which my Personal Representative may have an interest;</p>
<p class="indent-1">access, modify, control, archive, transfer, and delete my digital assets;</p>
<p class="indent-1">establish reserves, release powers, and abandon, settle, or contest claims; and</p>
<p class="indent-1">employ attorneys, accountants, custodians for trust assets, and other agents or assistants as my Personal Representative deems advisable to act with or without discretionary powers, and compensate them and pay their expenses from income or principal.</p>
</div>
...
<p class="indent-1">directly to a beneficiary;</p>
<p class="indent-1">in any form allowed by applicable state law for gifts or transfers to minors or persons under disability;</p>
<p class="indent-1">to a beneficiary's guardian, conservator, or caregiver for the beneficiary's benefit; or</p>
<p class="indent-1">by direct payment of the beneficiary's expenses.</p>
...
<h2>Article Five</h2>
<h3 style="text-align: center;">Administrative Provisions</h3>
...
<h2>Article Six</h2>
<h3 style="text-align: center;">Taxes, Claims, and Expenses</h3>
...
<h2>Article Seven</h2>
<h3 style="text-align: center;">General Provisions</h3>
...
<p class="indent-1">a direct contest brought by any beneficiary without probable cause;</p>
<p class="indent-1">any pleading by any beneficiary to challenge a transfer of property on the grounds that the transferor did not own the property at the time of the transfer; and</p>
<p class="indent-1">any filing of a creditor's claim or prosecution of any action based on the filing of such a claim.</p>
...
<p>Executed on {{TRUST_DATE_FORMATTED}} in the County of {{${prefix}_COUNTY}}, California.</p>
...
<p style="text-align: center; margin-top: 10px;">_________________________________</p>
</td>
<td width="50%" style="vertical-align: top;">
<div class="signature-line">Witness</div>
<p style="text-align: center; margin-top: 10px;">_________________________________</p>
