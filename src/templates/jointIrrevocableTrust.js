/**
 * Joint Irrevocable Trust Template
 * California Law - Irrevocable Trust for Joint Grantors
 * Complete template with all boilerplate language
 */

export const jointIrrevocableTrustTemplate = `
<!DOCTYPE html>
<html>
<head>
  <style>
...
<div class="title-page">
  ...
  <div class="subtitle">JOINT IRREVOCABLE TRUST AGREEMENT</div>
  <div class="law-firm">
...
<p>The date of this Joint Irrevocable Trust Agreement is {{TRUST_DATE_FORMATTED}}. The parties to the agreement are {{CLIENT_FULL_NAME}} ("First Grantor"), {{SPOUSE_FULL_NAME}} ("Second Grantor"), and {{TRUSTEE_NAME}} (the "Trustee"). First Grantor and Second Grantor are collectively referred to as "Grantors" or "we" or "us".</p>

<p>We intend that this agreement create a valid trust under the laws of California and under the laws of any state in which any trust created under this agreement is administered. The terms of this trust agreement prevail over any provision of California law, except those provisions that are mandatory and may not be waived.</p>

<p>Neither of us may serve as Trustee of any trust created under this agreement at any time.</p>
...
<p>This Trust is irrevocable, and we cannot alter, amend, revoke, or terminate it in any way, except as outlined below. Under Probate Code Section 15404, if the Grantors and all the beneficiaries of this trust consent, they may compel the modification or termination of this trust under Probate Code Section 15404 and no petition to the court is required.</p>

<p>Neither Grantor retains any beneficial interest in this trust. We are not beneficiaries and have no right to receive income or principal, to occupy or use trust property (including any residential real property held by the trust), or to direct distributions. We have no present or future interest in the trust property.</p>

<h2>Section 1.04      Transfers to the Trust</h2>

<p>We transfer to the Trustee the property listed in Schedule A, attached to this agreement, to be held on the terms and conditions set forth in this instrument. We retain no right, title or interest in the income or principal of this trust or any other incident of ownership in any trust property.</p>
...
<h2>Section 1.05      Statement of Our Intent</h2>

<p>We are creating this trust with the intent that assets transferred to the trust be held for the benefit of our trust beneficiaries on the terms and conditions set forth in this agreement. In order to maximize the benefit to our trust beneficiaries, we give the Trustee broad discretion with respect to the management, distribution and investment of assets in our trust. Our specific objectives in creating this trust include, but are not limited to:</p>

<p>Any gift made to the trust be treated as a completed gift for federal estate and gift tax purposes;</p>

<p>The assets of the trust estate be excluded for federal estate tax purposes from our gross estates and the gross estates of our trust beneficiaries except to the extent that the grant or exercise of a power of appointment is treated as a general power of appointment;</p>

<p>The assets in this trust not be subject to the claims of our creditors and any beneficiary's creditors; and</p>
...
<p>We intend that neither of us be taxed as owner of any portion of this trust for federal income tax purposes. All provisions of this trust agreement are to be construed consistent with this intent.</p>
...
<p>Notwithstanding any other provision of this trust that may seem to the contrary, neither of us nor any Trustee nor any entity in which either of us has a substantial interest may borrow from any trust created under this agreement, either directly or indirectly, without adequate interest or security. Any loan made to either of us must be made as exclusively determined by an Independent Trustee.</p>

<h3>(c)    Specific Administrative Powers Exercisable Only in Fiduciary Capacity</h3>

<p>If any trust created under this agreement includes corporate shares or other securities in which the holdings of either Grantor and the trust are significant from the viewpoint of voting control, only an Independent Trustee may vote or direct the voting of those corporate shares or other securities. Further, if the trust funds or assets include stocks or securities of entities in which the holdings of either Grantor and the trust are significant from the viewpoint of voting control, only an Independent Trustee—by direction or by veto—may control the investments or reinvestments of the trust.</p>
...
<p>The Trustee may not use the income of this trust to pay the premiums on any life insurance policies insuring the life of either Grantor. The Trustee may use other assets of the trust to pay such premiums.</p>
...
<p>The transferors (Grantors) are not beneficiaries of the trust;</p>
...
{{#IF_HAS_CHILDREN}}
<p>We have {{CHILDREN_COUNT}} child{{#IF_MULTIPLE_CHILDREN}}ren{{/IF_MULTIPLE_CHILDREN}}. {{#IF_MULTIPLE_CHILDREN}}They are{{/IF_MULTIPLE_CHILDREN}}{{#IF_SINGLE_CHILD}}Our child is{{/IF_SINGLE_CHILD}}:</p>

{{#EACH_CHILDREN}}
<p>{{CHILD_FULL_NAME}}, born on {{CHILD_DOB_FORMATTED}};</p>
{{/EACH_CHILDREN}}
{{/IF_HAS_CHILDREN}}

{{#IF_NO_CHILDREN}}
<p>We have no children.</p>
{{/IF_NO_CHILDREN}}
...
<p>A Trustee may resign by submitting a written notice of resignation. If either of us is incapacitated or deceased, a resigning Trustee shall give written notice to the Income Beneficiaries of the trust and to any other then-serving Trustee.</p>
...
<p>If {{TRUSTEE_NAME}} ceases to serve we name the following, in the order named, to serve as successor Trustee:</p>

{{#EACH_SUCCESSOR_TRUSTEES}}
<p>{{SUCCESSOR_TRUSTEE_NAME}}</p>
{{/EACH_SUCCESSOR_TRUSTEES}}
...
<p>Upon the death of the surviving Grantor, the Trustee shall administer and distribute our remaining trust property.</p>
...
<p>If {{BENEFICIARY_NAME}} does not survive us, this gift shall lapse and be distributed to {{LAPSE_TO}}.</p>

{{/EACH_SPECIFIC_DISTRIBUTIONS}}
{{/IF_HAS_SPECIFIC_DISTRIBUTIONS}}

{{#IF_NO_SPECIFIC_DISTRIBUTIONS}}
<p>We are not making any specific property distributions.</p>
{{/IF_NO_SPECIFIC_DISTRIBUTIONS}}

<h2>Section 4.02      General Needs Trust</h2>

{{#IF_HAS_GENERAL_NEEDS_TRUST}}
<p>We direct the Trustee to establish a General Needs Trust for {{GENERAL_NEEDS_BENEFICIARY_NAME}}. This trust is intended to supplement, not replace, any government benefits for which {{GENERAL_NEEDS_BENEFICIARY_NAME}} may be eligible.</p>
...
<p>We are not establishing a General Needs Trust.</p>
{{/IF_NO_GENERAL_NEEDS_TRUST}}

<h2>Section 4.03      Division of Remaining Trust Property</h2>

<p>After making the specific property distributions set forth in Section 4.01 and funding any General Needs Trust set forth in Section 4.02, the Trustee shall divide our remaining trust property into shares as follows:</p>
...
{{#EACH_RESIDUARY_BENEFICIARIES}}
<h2>Section 4.{{SECTION_NUMBER}}      Distribution of the Share for {{NAME}}</h2>
...
<h1>Article Five: Distributions During Lifetime and After Death of Either Grantor</h1>

<h2>Section 5.01      Distributions During Lifetime of Both Grantors</h2>

<p>During the lifetime of both Grantors, the Trustee shall hold and administer the trust property for the benefit of the trust beneficiaries as provided in Article Four and the other provisions of this trust. No distributions may be made to either Grantor. The Grantors have no beneficial interest in the trust property.</p>

<h2>Section 5.02      Death of First Grantor</h2>

<p>Upon the death of the first Grantor to die (the "First Deceased Grantor"), the surviving Grantor (the "Surviving Grantor") shall continue to have no beneficial interest in the trust. The Trustee shall continue to hold and administer the trust property for the benefit of the trust beneficiaries as provided in Article Four and the other provisions of this trust.</p>

<p>The death of the First Deceased Grantor does not trigger any distribution of trust property. The trust continues to be administered as a single irrevocable trust for the benefit of the trust beneficiaries named in Article Four.</p>

<p>The Surviving Grantor may not amend, modify, or revoke this trust, either in whole or in part, after the death of the First Deceased Grantor.</p>

<h2>Section 5.03      Death of Surviving Grantor</h2>

<p>Upon the death of the Surviving Grantor, the Trustee shall administer and distribute the remaining trust property in accordance with the provisions of Article Four and Article Six.</p>

<h1>Article Six: Remote Contingent Distribution</h1>

<p>If at any time no person or entity is qualified to receive final distribution of any part of our trust estate, this portion of our trust estate must be distributed to those persons who would inherit it had we then died intestate owning the property, as determined and in the proportions provided by the laws of California then in effect.</p>

<h1>Article Seven: Distributions to Underage and Incapacitated Beneficiaries</h1>

<h2>Section 7.01      Methods of Distribution</h2>

<p>If the Trustee is authorized or directed under any provision of this trust to distribute net income or principal to a person who has not yet reached 18 years of age or who is incapacitated as defined in Section 11.04(f), the Trustee may make the distribution by any one or more of the methods described in this Section. Alternatively, the Trustee may retain the trust property in a separate trust to be administered by the Trustee under Section 7.02.</p>

<p>We request that before making a distribution to a beneficiary, the Trustee consider, to the extent reasonable, the ability the beneficiary has demonstrated in managing prior distributions of trust property.</p>
...
<h2>Section 7.02      Retention in Trust</h2>
...
<h1>Article Eight: Trust Administration</h1>

<h2>Section 8.01      Distributions to Beneficiaries</h2>
...
<h2>Section 8.02      Beneficiary's Status</h2>
...
<h2>Section 8.03      No Court Proceedings</h2>
...
<h2>Section 8.05      Exoneration of the Trustee</h2>
...
<h2>Section 8.07      Trustee Compensation</h2>
...
<h2>Section 8.08      Employment of Professionals</h2>
...
<h2>Section 8.09      Exercise of Testamentary Power of Appointment</h2>
...
<h2>Section 8.10      Determination of Principal and Income</h2>
...
<h2>Section 8.11      Trust Accounting</h2>
...
<h2>Section 8.12      Information to Beneficiaries</h2>

<p>Privacy is an important issue to us. This Section defines the Trustee's duties to inform, account, and report to beneficiaries of various trusts created under this trust, and to other individuals during our lifetime and after our deaths. Except to the extent required by law, the Trustee is not required to comply with a request to furnish a copy of this trust to a Qualified Beneficiary at any time, and the Trustee is not required to send annual reports or reports upon termination of the trust to any Permissible Distributee or Qualified Beneficiary who requests the report. If the Trustee decides, in the Trustee's sole and absolute discretion, to provide any information to a Permissible Distributee or Qualified Beneficiary, the Trustee may exclude any information that the Trustee determines is not directly applicable to the beneficiary receiving the information. Any decision by the Trustee to make information available to any beneficiary does not constitute an obligation to provide any information to any beneficiary in the future.</p>

<h3>(a)    Providing Information While We Are Alive and Not Incapacitated</h3>

<p>We waive all duties of the Trustee to give notice, information, and reports to any Qualified Beneficiaries other than us while we are alive and able to effectively manage our financial resources. The Trustee is not required to keep Qualified Beneficiaries of any trust created under this trust other than us informed of the trust administration in any manner. Further, the Trustee is not required to respond to any request for information related to the trust administration from anyone who is not a Qualified Beneficiary, other than us.</p>

<h3>(b)    Providing Information If Either Grantor Is Alive but Incapacitated, and After Both Our Deaths</h3>

<p>During any period that either of us is alive but incapacitated and after both our deaths, the Trustee shall deliver any notice, information, or reports which would otherwise be required to be delivered to us or to a Qualified Beneficiary to a person designated by the Trustee. To preserve our privacy and the privacy of Qualified Beneficiaries under the trust, while either of us is alive, we request that the Trustee not provide any copies of the trust or any other information that may otherwise be required to be distributed to any beneficiary under California law to any beneficiary to whom the information is not directly relevant. The designated person may, in his or her sole and absolute discretion and without waiver, distribute copies of all or any part of the trust or other relevant information about the trust to one or more Qualified Beneficiaries or other interested parties during any period that either of us is incapacitated.</p>

<h2>Section 8.13      Action of Trustees and Delegation of Trustee Authority</h2>
...
<h2>Section 8.15      Trustee May Execute a Power of Attorney</h2>
...
<h2>Section 8.16      Additions to Separate Trusts</h2>
...
<h2>Section 8.18      Authority to Terminate Trusts</h2>
...
<h2>Section 8.19      Merger of Corporate Fiduciary</h2>
...
<h2>Section 8.20      Funeral and Other Expenses of Beneficiary</h2>
...
<h1>Article Nine: The Trustee's Powers</h1>

<h2>Section 9.01      Introduction to Trustee's Powers</h2>
...
<p>This Article provides the Trustee with comprehensive powers to hold, manage, and invest trust property for the benefit of the trust beneficiaries. Unless specifically limited in this trust, the Trustee may exercise any power granted in this Article in the Trustee's sole and absolute discretion.</p>

<h2>Section 9.02      Execution of Documents by the Trustee</h2>

<p>The Trustee may execute instruments, contracts, conveyances, and other documents in the Trustee's individual name as Trustee or in the trust name. The Trustee has no duty to disclose the fiduciary nature of the Trustee's capacity in executing documents or transacting business when disclosure might not be in the trust beneficiaries' best interest.</p>

<p>The Trustee may execute contracts, agreements, powers of attorney, and any other documents the Trustee considers appropriate or necessary to administer the trust.</p>

<h2>Section 9.03      Investment Powers in General</h2>
...
<p>We have provided that certain trust beneficiaries receive payments of periodic unitrust amounts. Our intent is to allow the Trustee to invest trust assets for total return rather than solely for income. This will allow the Trustee to provide regular payments to current beneficiaries that will keep pace with inflation in future years, while providing for the remainder beneficiaries and preserving the value and purchasing power of their trust interest.</p>

<p>Without limiting the Trustee's investment authority in any way, we request that the Trustee exercise reasonable care and skill in selecting and retaining trust investments. We also request that the Trustee take into account the following factors in choosing investments:</p>
...
<p>We request that the Trustee also consider the possible effects of inflation or deflation, changes in global and US economic conditions, transaction expenses, and the trust's need for liquidity while arranging the trust's investment portfolio.</p>
...
<h2>Section 9.04      Banking Powers</h2>
...
<h2>Section 9.05      Business Powers</h2>
...
<h2>Section 9.06      Contract Powers</h2>
...
<h2>Section 9.07      Common Investments</h2>
...
<h2>Section 9.10      Farming and Ranching Operations</h2>
...
<p>In addition to the compensation set forth in Section 8.07, the Trustee may receive additional reasonable compensation for services in connection with the operation of a farm or ranch. The Trustee may receive this compensation directly from the farm or ranch, the trust, or both.</p>
...
<h2>Section 9.11      Insurance Powers</h2>

<p>The Trustee may purchase, accept, hold, and deal with as owner, insurance policies on the life of either Grantor, any beneficiary's life, or any person's life in whom any beneficiary has an insurable interest.</p>
...
<p>After the death of either Grantor, the Trustee may hold any policy, may proceed to collect the proceeds of any policy, or may sell or surrender any policy. The Trustee may exercise any option provided in or available under the terms of any policy. The Trustee may use any life insurance policy proceeds to purchase investments for the trust or to pay all or any part of any debts, estate, or inheritance tax of a decedent as directed in this trust.</p>

<p>The Trustee may exercise any rights of conversion or exchange on any policy. The Trustee may pay premiums on any life insurance policy that is an asset of the trust either from income or from principal as the Trustee deems advisable.</p>

<h2>Section 9.12      Loans and Borrowing Powers</h2>

<p>The Trustee may lend or advance money from trust property to or for the benefit of any trust beneficiary on those terms and conditions the Trustee considers advisable.</p>

<p>The Trustee may borrow money on behalf of the trust and may provide a note or mortgage or grant other security interest in any part of the trust property to secure the loan.</p>

<p>The Trustee may guarantee the debts and obligations of any trust beneficiary on those terms and conditions the Trustee considers advisable, and may use trust property to secure the guarantee.</p>

<h2>Section 9.13      Nominee Powers</h2>

<p>The Trustee may register any investments held in the trust in the name of a nominee, with or without disclosing the trust, or in another form the Trustee determines to be appropriate. The Trustee will keep records sufficient to identify each investment held in nominee form.</p>

<h2>Section 9.14      Oil, Gas and Mineral Interests</h2>

<p>The Trustee may lease mineral and hydrocarbon interests in property held by the trust or owned by any beneficiary. The Trustee may enter into community oil leases, pooling and unitization agreements.</p>

<p>The Trustee may lease oil, gas, and other mineral interests on any terms that the Trustee considers advisable, regardless of whether the lease's term extends beyond the period of time permitted by statute for leases. The Trustee may enter into and extend or renew leases at the Trustee's discretion. This may include extending or renewing leases that either of us entered into.</p>

<p>The Trustee may enter into contracts for the exploration for and the removal of oil, gas, and other minerals, as well as contracts for the unitization or pooling of lands, minerals, royalties, or leasehold interests, and for the sale, processing, or other disposition of oil and gas and related hydrocarbons or other minerals removed under these leases or contracts.</p>

<h2>Section 9.15      Payment of Property Taxes and Expenses</h2>

<p>The Trustee may pay all taxes, assessments, reasonable maintenance, and other ordinary expenses incurred in the collection, care, administration, and protection of any trust.</p>

<h2>Section 9.16      Professional Practice</h2>
...
<p>For purposes of this Article, the term professional practice means an interest in a medical, dental, legal, veterinary, accounting, architectural, engineering, or other professional practice in which either of us participates as a licensed person. The term includes our interest in any corporation, partnership, sole proprietorship, limited liability company, joint venture, or other entity that is engaged in providing the kind of professional services that either of us is licensed to practice.</p>
...
<p>Following the death of either or both of us or in the event of our permanent disability, we prefer that the Trustee sell any interest in a professional practice owned by the trust as quickly as practicable in order to protect the value of the practice. The Trustee may sell our interest in the professional practice on terms the Trustee considers appropriate.</p>
...
<p>The Trustee is forbidden from reading or reviewing client or patient records and files of the professional practice if doing so would violate our professional obligation to the client or patient. The Trustee may employ another licensed professional or professional assistant to read and review client or patient records for any appropriate purpose. The Trustee will ensure that the review is conducted consistent with the best ethical practices of our profession, safeguarding confidentiality and avoiding conflicts of interest.</p>

<h3>(e)    Trustee Compensation</h3>

<p>In addition to the compensation set forth in Section 8.07, the Trustee may receive additional reasonable compensation for services in connection with the operation, sale, or winding up of the professional practice. The Trustee may be compensated directly from the professional practice, the trust, or both.</p>
...
<h2>Section 9.17      Purchase of Assets from and Loans to Our Probate Estates</h2>

<p>Upon the death of either or both of us, the Trustee may purchase at fair market value and retain in the form received any property that is a part of either of our probate or trust estates as an addition to the trust. In addition, the Trustee may make secured and unsecured loans to either of our probate or trust estates. The Trustee may not be held liable for any loss suffered by the trust because of the exercise of the powers granted in this Section.</p>

<p>The Trustee may not use any trust property for the benefit of either of our estates as defined in Code of Federal Regulations Title 26 Section 20.2042-1(b), unless the property is included in the respective Grantor's gross estate for federal estate tax purposes.</p>

<h2>Section 9.18      Qualified Tuition Programs</h2>
...
<h2>Section 9.19      Real Estate Powers</h2>
...
<p>The Trustee may partition real property, may grant easements, may dedicate property for public use, and may make any covenant or grant of restriction concerning the use of real property.</p>

<p>The Trustee may construct, alter, raze, and replace any building on real property held by the trust. The Trustee may settle any boundary, encroachment, easement, or other real property disputes. The Trustee may lease property for any term of years, including a term in excess of the maximum term allowable by local law.</p>

<h2>Section 9.20      Residences and Tangible Personal Property</h2>

<p>This Section applies to residential real property owned by the trust and any tangible personal property.</p>

<p>The Trustee may permit any trust beneficiary or anyone who has the responsibility for the care of a beneficiary to use residential property, and permit any trust beneficiary to use tangible personal property, under terms and conditions the Trustee considers advisable. No rent or other consideration will be required as a condition of using residential property or tangible personal property.</p>

<p>The Trustee may pay the costs of maintenance, taxes, insurance, and other carrying charges of the property. The Trustee may insure the property at replacement value and may insure any beneficiary using the property against liability arising from ownership or use of the property.</p>

<p>The Trustee may distribute the property to a beneficiary for whom the property is held or to the beneficiary's Legal Representative, or may sell the property and distribute the proceeds. The Trustee may decline to distribute personal property to a beneficiary if the Trustee determines that distribution to the beneficiary would not be prudent.</p>

<h2>Section 9.21      Retention and Abandonment of Trust Property</h2>

<p>Notwithstanding any duty the Trustee may have to diversify investments or to sell any property, the Trustee may retain for any period of time, all or any part of the original property, or any other property acquired by gift, devise, bequest, purchase, or exchange. The Trustee may retain a particular investment even if it constitutes a substantially disproportionate part of a trust, and even if retention would not otherwise be considered prudent.</p>

<p>Any retention continues without liability to the Trustee for any depreciation or loss of the property, regardless of whether the loss may have been prevented by selling the property. Any retention may be done without regard to any duty the Trustee may have to make the trust property productive of income.</p>

<p>The Trustee may abandon property that in the Trustee's opinion has little or no value. However, the Trustee may not abandon property if the property may have any value that may be realized or if the abandonment may create a liability for the trust.</p>

<h2>Section 9.22      Securities, Brokerage and Margin Powers</h2>

<p>The Trustee may buy, subscribe for, and otherwise acquire corporate obligations, mutual funds, exchange-traded funds, money market accounts, common trust funds, stocks, bonds, notes, debentures, certificates of deposit, and other corporate or governmental securities.</p>

<p>The Trustee may sell, transfer, and exchange any or all securities owned by the trust and participate in any sale, merger, reorganization, consolidation, voting trust, or other transaction or right affecting securities owned by the trust.</p>

<p>The Trustee may open and maintain brokerage accounts with a securities broker/dealer in the name of the trust, and may pay all brokerage fees that may be charged in connection with the brokerage account.</p>

<h2>Section 9.23      Settlement Powers</h2>

<p>The Trustee may compromise, settle, arbitrate, or abandon any claim in favor of or against the trust. The Trustee may represent the trust in legal proceedings and may employ one or more attorneys to represent the trust or to advise the Trustee.</p>

<h2>Section 9.24      Subchapter S Corporation Stock Provisions</h2>

<p>The Trustee may hold and retain stock in a corporation that has made an election to be taxed as a small business corporation as defined in Subchapter S of the Internal Revenue Code. Provisions of this Section apply if the trust holds stock in a Subchapter S Corporation.</p>

<h3>(a)    Administration of the Trust as an Electing Small Business Trust (ESBT)</h3>

<p>The Trustee may elect to treat the trust or any portion of the trust as an electing small business trust (ESBT) under Internal Revenue Code Section 1361(e). The Trustee may elect to treat the trust or separate trust as an ESBT at any time during the period the trust holds Subchapter S Corporation stock, and the Trustee may revoke this election at any time the Trustee determines that ESBT status is no longer advisable.</p>

<p>If the Trustee elects to treat the trust as an ESBT, the following provisions will apply:</p>

<h4>(1)    Payment of Tax</h4>

<p>The ESBT portion of the trust may or may not provide distributions to trust beneficiaries. If the Trustee determines that the trust should be primarily responsible for the income tax attributable to the S corporation stock, the Trustee may apportion trust income and pay trust expenses in a manner that provides the trust with adequate cash or liquid resources to pay the income tax attributable to the S corporation stock allocated to the ESBT, even though no distributions are made to trust beneficiaries. This apportionment may be done without regard to whether the normal apportionment of income, principal, receipts, and disbursements might otherwise favor current beneficiaries or favor remainder beneficiaries.</p>

<h4>(2)    Distribution of Trust Income to Pay Tax</h4>

<p>Alternatively, the Trustee may elect to distribute net income or principal from the trust to trust beneficiaries in amounts adequate for trust beneficiaries to be able to pay the income tax liability that may be attributable to their share of trust income. The Trustee may estimate the amount of a trust beneficiary's income tax liability associated with the Subchapter S Corporation stock if the trust is treated as an ESBT, and may make distributions to the trust beneficiary based upon that estimate.</p>

<h4>(3)    Provision of Information to Trust Beneficiaries</h4>

<p>Notwithstanding any provision in this trust that may grant the Trustee broad discretion to determine what information should be provided to trust beneficiaries, the Trustee shall provide current beneficiaries with full information about the corporation and the corporation's operating results, financial position, and prospects for future distributions if the Trustee treats the trust as an ESBT. The purpose of this provision is to enable trust beneficiaries to make informed decisions about the corporation and their beneficial interest in the trust.</p>

<h3>(b)    Administration of the Trust as a Qualified Subchapter S Trust (QSST)</h3>

<p>Alternatively, the Trustee may elect to treat the trust or any portion of the trust as a qualified Subchapter S trust (QSST) under Internal Revenue Code Section 1361(d).</p>

<p>The following requirements apply to any trust or trust portion treated as a QSST:</p>

<h4>(1)    Distribution Provisions</h4>

<p>While any portion of the trust is treated as a QSST, the trust shall distribute all net income attributable to the Subchapter S Corporation stock at least annually to the single trust beneficiary.</p>

<h4>(2)    Principal Distributions</h4>

<p>If the trust property includes only the stock of the Subchapter S Corporation, the Trustee may distribute trust principal only to that beneficiary as long as the trust is treated as a QSST.</p>

<p>If the trust property holds property other than the stock of the Subchapter S Corporation, and if this additional trust property is segregated and administered as a separate trust, the Trustee is not limited in making distributions of principal from the trust holding property other than the Subchapter S Corporation stock.</p>

<h4>(3)    Provision of Information to Trust Beneficiaries</h4>

<p>If the Trustee treats the trust as a QSST, the Trustee shall provide complete information to the beneficiary about the income and value of the QSST portion of the trust so that the beneficiary can accurately report the income generated by the Subchapter S Corporation on his or her income tax return.</p>

<h3>(c)    Power to Segregate the Subchapter S Corporation Stock into a Separate Trust</h3>

<p>The Trustee has the power to segregate the S corporation stock into a separate trust from other trust property. If the Trustee exercises this power, then the Trustee shall administer the S corporation stock in accordance with the terms of this trust, but the segregation permits the Trustee to treat the S corporation stock differently from other trust property.</p>

<h3>(d)    Power to Convert Distributions to a Percentage</h3>

<p>The Trustee has the power to convert income interests under any trust created under this trust document to a fixed-percentage interest if the Trustee determines that such conversion is necessary or advisable for purposes of qualifying the trust as a qualified Subchapter S trust or as an electing small business trust.</p>

<p>This power is exercisable whether or not the trust has a disinterested Trustee. The Trustee has the discretion to determine the appropriate percentage and the basis upon which that percentage will be computed.</p>

<h3>(e)    Power to Distribute S Corporation Stock to a Beneficiary</h3>

<p>The Trustee may distribute S corporation stock from any trust created under this trust at any time to a trust beneficiary or to a trust for that beneficiary's benefit that qualifies as a permitted shareholder of the S corporation stock. Upon the distribution of stock to a beneficiary or the beneficiary's trust, the Trustee is to treat the fair market value of the stock as a distribution of principal.</p>

<h3>(f)    Gift of S Corporation Stock</h3>

<p>If any trust beneficiary makes a completed gift of S corporation stock to the trust and the trust does not qualify as a permitted shareholder of the S corporation stock, the Trustee shall distribute the stock to a permissible shareholder within a reasonable time following the gift. The Trustee may select the permissible shareholder who will receive the stock in the Trustee's sole and absolute discretion.</p>

<h3>(g)    Termination of S Corporation Status</h3>

<p>If a corporation terminates its S corporation election or if the corporation's S corporation election is otherwise terminated, the Trustee may administer the trust in the manner provided in this trust without regard to the restrictions set forth in this Section.</p>

<h3>(h)    Order of Precedence</h3>

<p>The provisions of this Section control over any inconsistent provision in this trust.</p>

<h2>Section 9.25      Limitation on the Trustee's Powers</h2>

<p>No power the Trustee holds under this trust may be exercised in a manner that would disqualify the trust, or trust property, from obtaining any federal income tax, federal gift tax, federal estate tax, or federal generation-skipping transfer tax benefit we intended when creating this trust. Further, the Trustee may not exercise any power in a way that shifts a beneficiary's interest to any lower generation for generation-skipping transfer tax purposes as defined in Internal Revenue Code Section 2612(c).</p>

<p>The Trustee shall not exercise any power granted in this agreement in a manner inconsistent with our directions set forth in Section 1.05 and 1.06.</p>

<p>The Trustee may not delegate any decision-making function to an Interested Trustee if that function could cause adverse estate or income tax consequences to the trust or to a trust beneficiary.</p>

<h1>Article Ten: General Provisions</h1>

<h2>Section 10.01      Maximum Term for Trusts</h2>

<p>Notwithstanding any other provision contained in this trust, all trusts created under this trust will terminate no later than 21 years after the death of the last to die of the beneficiaries living on the date of this trust's creation. Upon that termination, the Trustee will distribute any remaining trust property to the beneficiaries then entitled to receive income payments from the trust. If more than one beneficiary is then entitled to receive income payments from the trust, the beneficiaries will receive equal shares of the trust.</p>

<h2>Section 10.02      Spendthrift Provision</h2>

<p>We intend that each trust created under this trust be a spendthrift trust to the maximum extent permitted by law. A beneficiary may not voluntarily or involuntarily anticipate, encumber, or transfer their interest in any trust created under this trust. Neither the income nor principal of any trust created under this trust is subject to any process, execution, levy, sale, garnishment, attachment, bankruptcy, or insolvency proceedings of any nature by any creditor or assignee of a beneficiary. The Trustee may, in its sole discretion, make payments for a beneficiary to a third party in satisfaction of claims brought by that third party.</p>

<p>The spendthrift provisions of this Section do not apply to the Trustee's right to receive compensation for serving as the Trustee, or to any agreement between the trust and a beneficiary regarding the trust and entered into after that beneficiary has attained 18 years of age.</p>

<h2>Section 10.03      Changing the Governing Law and Situs of Administration</h2>

<p>The Trustee may change the place of administration of any trust created under this trust. When the place of administration is changed, the Trustee may elect to subject the administration of any trust created under this trust to the law of the jurisdiction where the place of administration is changed.</p>

<h2>Section 10.04      Definitions</h2>

<p>The terms and phrases used in this trust have the meanings set forth below.</p>

<h3>(a)    Adopted and Afterborn Persons</h3>

<p>A person is a child or descendant of an individual if that person is born to or legally adopted by the individual within two years after the individual's death. Further, I specifically include as beneficiaries of this trust all of my descendants in being at the time of my death regardless of their parents' marital status, and all of my descendants thereafter born or legally adopted as defined above. Descendants include adopted persons and persons born out of wedlock.</p>

<h3>(b)    Descendants</h3>

<p>The term descendants means the children, grandchildren, great-grandchildren, and all other lineal descendants—by blood or legal adoption—to the remotest degree. This term includes a child who has been conceived but not yet born at a certain date if that child is later born alive. Descendants includes adopted persons and persons born out of wedlock.</p>

<h3>(c)    Education</h3>

<p>Education includes attending, and preparation for attending, an accredited private or public vocational school, academic high school, prep school, junior college, college, university, or postgraduate or professional school. Distributions for education may include tuition, fees, books, supplies, equipment, and incidental expenses, as well as lodging expenses, reasonable living expenses, and travel expenses to and from home.</p>

<h3>(d)    Good Faith</h3>

<p>The Trustee acts with good faith if the Trustee acts in honest belief without any fraudulent intent or reckless indifference to the interest of trust beneficiaries.</p>

<h3>(e)    Grantors</h3>

<p>The terms "Grantors," "we," "us," and "our" refer collectively to {{CLIENT_FULL_NAME}} and {{SPOUSE_FULL_NAME}}.</p>

<h3>(f)    Either Grantor</h3>

<p>The term "Either Grantor" means {{CLIENT_FULL_NAME}} or {{SPOUSE_FULL_NAME}}, individually.</p>

<h3>(g)    Surviving Grantor</h3>

<p>The term "Surviving Grantor" means the Grantor who survives the death of the other Grantor.</p>

<h3>(h)    Incapacity</h3>

<p>A person is incapacitated when any of the following conditions is satisfied:</p>

<h4>(1)    The Opinion of Two Licensed Physicians</h4>

<p>Two physicians licensed to practice medicine certify in writing that the person is unable to effectively manage their financial resources or to resist fraud or undue influence. The written opinion of the two physicians will be conclusive evidence of the person's capacity or incapacity.</p>

<h4>(2)    Court Determination</h4>

<p>A court with jurisdiction determines the person is unable to manage his or her estate.</p>

<h4>(3)    Detention, Disappearance, or Absence</h4>

<p>If the person is detained by a foreign power, is missing, or is for any other reason unable to effectively manage his or her financial resources and resist fraud or undue influence. If any such situation occurs, the person may be treated as incapacitated without medical opinion or court determination.</p>

<h3>(i)    Include, Includes, Including</h3>

<p>The terms include, includes, and including mean include, includes, or including but not limited to.</p>

<h3>(j)    Income Beneficiary</h3>

<p>The Income Beneficiary of a trust is a person or persons who is entitled to receive income payments from the trust or who may receive discretionary distributions from the net income of the trust. If a person may receive discretionary distributions of net income or principal, the person will be treated as an Income Beneficiary.</p>

<h3>(k)    Independent Trustee</h3>

<p>An Independent Trustee is any Trustee other than me, any trust beneficiary, or anyone who is subordinate or subservient to me or to any beneficiary. A person is subordinate or subservient if that person is a nonadverse party, as that term is defined in Internal Revenue Code Section 672(a) and the Treasury Regulations under that section.</p>

<h3>(l)    Instrument</h3>

<p>An instrument means a will, codicil, living trust, trust amendment, or any other form of written direction that the person may lawfully use to dispose of their property at death. This also includes a beneficiary designation on an insurance contract, annuity contract, or retirement plan.</p>

<h3>(m)    Interested Trustee</h3>

<p>An Interested Trustee is any Trustee who is not an Independent Trustee.</p>

<h3>(n)    Internal Revenue Code and Treasury Regulations</h3>

<p>Internal Revenue Code means the Internal Revenue Code of 1986, as now enacted or later amended. Treasury Regulations means the final, temporary, or proposed Treasury Regulations promulgated under the Internal Revenue Code, as now enacted or later amended.</p>

<h3>(o)    Legal Representative or Personal Representative</h3>

<p>The Legal Representative or Personal Representative of a person is the executor, administrator, conservator, guardian, custodian, attorney in fact under a durable power of attorney for asset management, parent, or other person having legal authority to act for the person as to the matter in question.</p>

<h3>(p)    Per Stirpes</h3>

<p>The term per stirpes refers to a distribution method whereby property is divided into equal shares at the generational level nearest to the designated ancestor which contains one or more then-living descendants. Each living descendant at this nearest generational level receives one share. Each deceased person at this level who has one or more living descendants will also have a share created. A deceased person's share is further divided among that person's then-living descendants in the same manner.</p>

<h3>(q)    Permissible Distributee</h3>

<p>The Permissible Distributees of any trust created under this trust are the persons or group of persons to whom a distribution of income or principal from the trust may be made.</p>

<h3>(r)    Primary Beneficiary</h3>

<p>The Primary Beneficiary of a trust is the person or persons for whom the trust is created and whose well-being is the Trustee's principal concern.</p>

<h3>(s)    Qualified Beneficiary</h3>

<p>The Qualified Beneficiaries of a trust at any particular time means the persons or group of persons who on that date:</p>

<p>(1) are receiving or eligible to receive distributions of trust income or principal under the terms of the trust; or</p>
...
<h3>(t)    Shall and May</h3>

<p>Unless otherwise specifically provided in this trust or by the context in which used, we use the word shall in this trust to impose a duty, command, direct, or require, and the word may to allow or permit, but not require. In the context of the Trustee, when we use the word shall we intend to impose a fiduciary duty on the Trustee. When we use the word may we intend to empower the Trustee to act with the Trustee's sole and absolute discretion unless otherwise stated in this trust. When we use the words may not in reference to the Trustee, we specifically mean the Trustee is not permitted to.</p>
...
<p>This trust is governed, construed, and administered according to the laws of California, as amended except as to trust property required by law to be governed by the laws of another jurisdiction and unless the situs of administration is changed under Section 10.03.</p>
...
<p class="no-indent">We have executed this trust on {{TRUST_DATE_FORMATTED}}.</p>

<p class="no-indent">This Joint Irrevocable Trust Agreement is effective when signed by us, whether or not now signed by a Trustee.</p>

<p class="no-indent" style="margin-top: 40px;">_______________________________</p>
<p class="no-indent">{{CLIENT_FULL_NAME}}, First Grantor</p>

<p class="no-indent" style="margin-top: 40px;">_______________________________</p>
<p class="no-indent">{{SPOUSE_FULL_NAME}}, Second Grantor</p>
...
<p class="no-indent">STATE OF CALIFORNIA )</p>
<p class="no-indent" style="margin-left: 2in;">) ss.</p>
<p class="no-indent">COUNTY OF {{SPOUSE_COUNTY}} )</p>

<p>On {{TRUST_DATE_FORMATTED}}, before me, ____________________________, a Notary Public, personally appeared {{SPOUSE_FULL_NAME}}, who proved to me on the basis of satisfactory evidence to be the person(s) whose name(s) is/are subscribed to the within instrument and acknowledged to me that he/she/they executed the same in his/her/their authorized capacity(ies), and that by his/her/their signature(s) on the instrument the person(s), or the entity upon behalf of which the person(s) acted, executed the instrument.</p>
...
<p class="no-indent" style="margin-top: 40px;">First Grantor Signature: _______________________________</p>
<p class="no-indent">{{CLIENT_FULL_NAME}}, First Grantor</p>

<p class="no-indent" style="margin-top: 40px;">Second Grantor Signature: _______________________________</p>
<p class="no-indent">{{SPOUSE_FULL_NAME}}, Second Grantor</p>
</div>
